...
// This function is an alternative to includes builtin function
function checkInArray(array : string[], searchWord : string) : boolean{
    for(let x = 0; x < array.length ; x++){
        if(array[x] == searchWord){
            return true
        } 
    }
    return false
...
console.log(checkInArray(fruits, "banana"));  

console.log("Is 'grape' not in the fruits array? I predict False.");
console.log(checkInArray(fruits, "grape")); 
...
var alien_color = "green";
if(alien_color === "green"){
    console.log("You got 5 points by shooting the alien");
}else{
    console.log("You just earned 10 points");
}

var alien_color = "red"; // Change the color to something other than green
if(alien_color === "green"){
    console.log("You got 5 points by shooting the alien");
}else{
    console.log("You just earned 10 points");
...
// • Write four if statements. Each should check whether a certain kind of fruit is in your array. If the fruit is in your array, the if block should print a statement, such as You really like bananas!

var favorite_fruits : string[] = ["Mango", "Peach", "Strawberrys"];

for(let x = 0; x < favorite_fruits.length ; x++){
    if(favorite_fruits[x] === "Mango"){
        console.log("You really like Mongoe's")
    }else if(favorite_fruits[x] === "Peach"){
        console.log("You really like peach")
    }else if(favorite_fruits[x] === "Strawberrys"){
        console.log("You really like Strawberrys")
    }else{
        console.log("Sorry bro, your favourte fruit is not in the list")
    }
}
...
var usernames: string[] = ["admin", "Hadi", "Mahad", "Momin", "Wali"];
...
var current_users : string[] = ["Emily", "Ethan", "Sophia", "Liam", "Olivia"]
var new_users : string[] = ["Noah", "Sophia", "Liam", "Isabella", "Benjamin"]

function checkUser(array : string[], user : string) : boolean {
...
for(let i = 0; i < new_users.length ; i++){
    if(checkInArray(current_users, new_users[i]) === true){
        console.log("User " + new_users[i] + ", is already taken enter a new username")
    }else{
...
var pizza : string[] = ["roman", "sicilian", "margherita"];
...
// • Modify your program to print a statement about each animal, such as A dog would be a great pet. 
// • Add a line at the end of your program stating what these animals have in common. You could print a sentence such as Any of these animals would make a great pet!

var animals : string[] = ["dog", "cat", "parrot"]
for(let i = 0; i < animals.length ; i++){
    console.log("A " + animals[i] + " will be a great pet.");
}
...
function make_shirt(size: string = "large", message: string = "I love TypeScript") {
    ...
    console.log(`The message to print on T-shirt is '${message}'.`);
}
...
function describe_city(city:string = "Karachi", country:string = "Pakistan"){
    console.log(city + " lies insight of " + country)
}
describe_city()
...
console.log(city_country('New York City', 'United States'));
...
var magician_names : string[] = ["David Copperfield", "Harry Houdini", "Penn & Teller", "Dynamo", "Criss Angel", "David Blaine", "Derren Brown", "Lance Burton", "Ricky Jay", "Shin Lim"]
...
let magicianNamesCopy: string[] = magician_names.slice();
...
make_sandwich("Ham", "Swiss Cheese", "Pickles");
make_sandwich("Tuna", "Mayonnaise");

// 45) Cars: Write a function that stores information about a car in a Object. The function should always receive a manufacturer and a model name. It should then accept an arbitrary number of keyword arguments. Call the function with the required information and two other name-value pairs, such as a color or an optional feature. Print the Object that’s returned to make sure all the information was stored correctly.

function carInfo(manufacturer: string, model: string, ...options: string[]): { manufacturer: string, model: string, options: string[] } {
    let car: { manufacturer: string, model: string, options: string[] } = {
...
let myCar = carInfo("Toyota", "Camry", "Silver", "Sunroof", "Navigation System");
console.log(myCar);