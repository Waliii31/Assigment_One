...
function checkInArray(array, searchWord) {
    for (var x_1 = 0; x_1 < array.length; x_1++) {
        if (array[x_1] == searchWord) {
            return true;
        }
    }
    return false;
...
var favorite_fruits = ["Mango", "Peach", "Strawberrys"];
for (var x_2 = 0; x_2 < favorite_fruits.length; x_2++) {
    if (favorite_fruits[x_2] === "Mango") {
        console.log("You really like Mongoe's");
    }
    else if (favorite_fruits[x_2] === "Peach") {
        console.log("You really like peach");
    }
    else if (favorite_fruits[x_2] === "Strawberrys") {
...
var usernames = ["admin", "Hadi", "Mahad", "Momin", "Wali"];
...
var current_users = ["Emily", "Ethan", "Sophia", "Liam", "Olivia"];
var new_users = ["Noah", "Sophia", "Liam", "Isabella", "Benjamin"];
...
for (var i_2 = 0; i_2 < new_users.length; i_2++) {
    if (checkInArray(current_users, new_users[i_2]) === true) {
        console.log("User " + new_users[i_2] + ", is already taken enter a new username");
    }
    else {
        console.log("Username " + new_users[i_2] + ", is available");
    }
}
...
var pizza = ["roman", "sicilian", "margherita"];
for (var i_4 = 0; i_4 < pizza.length; i_4++) {
    console.log("I like " + pizza[i_4] + " pizza.");
}
...
for (var i_5 = 0; i_5 < animals.length; i_5++) {
    console.log("A " + animals[i_5] + " will be a great pet.");
}
...
function make_shirt(size, message) {
    ...
    console.log("The message to print on T-shirt is '".concat(message, "'."));
}
make_shirt();
...
var magician_names = ["David Copperfield", "Harry Houdini", "Penn & Teller", "Dynamo", "Criss Angel", "David Blaine", "Derren Brown", "Lance Burton", "Ricky Jay", "Shin Lim"];
function show_magicians(array) {
    for (var i_6 in array) {
        console.log(array[i_6]);
    }
}
...
var magicianNamesCopy = magician_names.slice();
...
var myCar = carInfo("Toyota", "Camry", "Silver", "Sunroof", "Navigation System");
console.log(myCar);
